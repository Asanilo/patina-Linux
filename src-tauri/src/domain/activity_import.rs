...
pub const MAX_APP_IDENTIFIER_BYTES: usize = 512;
pub const MAX_APP_NAME_BYTES: usize = 512;
pub const MAX_WINDOW_TITLE_BYTES: usize = 8 * 1024;
...
pub fn record_fingerprint(record: &CanonicalImportRecord) -> String {
