...
const DESKTOP_ENDPOINTS: &[ApiEndpoint] = &[
    ApiEndpoint {
        method: "GET",
        path: "/api/v1/classification/observed-apps",
    },
    ApiEndpoint {
        method: "GET",
        path: "/api/v1/heatmap",
...
const DAEMON_TRACKING_ENDPOINTS: &[ApiEndpoint] = &[
    ...
    ApiEndpoint {
        method: "POST",
        path: "/api/v1/backups/restore/cancel",
    },
    ApiEndpoint {
        method: "POST",
    ...
    ApiEndpoint {
        method: "POST",
        path: "/api/v1/backups/remote/list",
    },
    ApiEndpoint {
        method: "POST",
        path: "/api/v1/backups/remote/restore",
    },
    ApiEndpoint {
        method: "POST",
        path: "/api/v1/apps/{exe_name}/classify",
...
mod tests {
    ...
    fn desktop_surface_keeps_shared_client_method_and_path_set() {
        assert_eq!(ApiSurface::Desktop.endpoints().len(), 26);
        assert!(ApiSurface::Desktop.allows("GET", "/api/v1/classification/observed-apps"));
        assert!(!ApiSurface::Desktop.allows("POST", "/api/v1/classification/observed-apps"));
    ...
    fn daemon_tracking_surface_owns_tracking_and_exposes_bounded_writes() {
        ...
        assert!(surface.allows("POST", "/api/v1/backups/remote/list"));
        assert!(surface.allows("POST", "/api/v1/backups/remote/restore"));
        assert_eq!(
