...
| `patinad` | Stage 2E MPRIS preview | `--serve-api --track` runs tracking/watchdog, power lifecycle handling, PulseAudio/pipewire-pulse, and MPRIS participation sources for an isolated profile. Desktop remains the default owner; this is not a released background service. |
